...
#ifdef HTC_SUPPORT
extern void xml_bfd_elf_program_header (bfd *, p_xml_element);
bfd_boolean xml_bfd_elf_version_definitions (bfd *, p_xml_element);
bfd_boolean xml_bfd_elf_version_references (bfd *, p_xml_element);
#endif
...
#define SEC_PCP 0x10000000
  ...
  /* Infineon TriCore/Freescale/ST PPC: we use the high 3-Bit to encode the core number */
#define SEC_CORE_NUMBER_MASK   0xe0000000
#define SEC_CORE_NUMBER_SHIFT  29
#define SEC_CORE_NUMBER(n)     (((n) & 0x7) << SEC_CORE_NUMBER_SHIFT)
#define SEC_CORE_NUMBER_GET(n) (((n) & SEC_CORE_NUMBER_MASK) >> SEC_CORE_NUMBER_SHIFT)

  /* This section should not be initialized. Only for SLE9X */
#define SEC_SLE90_NOINIT     0x10000000

  /* An absolute addressable section. Only for SLE9x */
#define SEC_SLE90_ABS        0x20000000

  /* An absolute addressable section. Only for TRICORE */
#define SEC_ABSOLUTE_DATA    0x04000000

  /* This section may not be cleared or initialized. Only for SLE9x */
#define SEC_SLE90_NOCLEAR    0x40000000

  /* This section should not be initialized. Only for SLE9X */
#define SEC_SLE90_READABLE   0x80000000

  /* Indicate that section has the no read flag set. This happens
     when memory read flag isn't set. */
#define SEC_COFF_NOREAD 0x40000000

  /* this is a powerpc vle section */
#define SEC_PPC_VLE    0x10000000
...
#define bfd_mach_ppc_e200zx    200
#define bfd_mach_ppc_z420n3    420
...
#define bfd_mach_tic4x         40
  ...
  bfd_arch_tricore,   /* Infineon TriCore CPU/MCU/DSP */
...
/* Marker for relax operations in linker */
...
/* This is a register indirect reloc for the I51 */
  BFD_RELOC_I51_R1,
/* This is a register reloc for the I51 */
  BFD_RELOC_I51_R3,
/* This is a 16 bit reloc for the I51 -  8 bit signed pc relative */
  BFD_RELOC_I51_7_PCREL,
/* This is a 16 bit reloc for the I51 -  11 bit absolute inpage */
  BFD_RELOC_I51_11,
/* This is a bit register reloc for the I51 */
  BFD_RELOC_I51_8_BIT,
/* This is a LOW(16BIT) reloc for the I51 */
  BFD_RELOC_I51_8_LOW,
/* This is a HIGH(16BIT) reloc for the I51 */
  BFD_RELOC_I51_8_HIGH,
/* This is a Byte2Bit reloc for the I51 */
  BFD_RELOC_I51_8_B2B,
  /* This is a 13 bit Pcode reloc for the I51 */
