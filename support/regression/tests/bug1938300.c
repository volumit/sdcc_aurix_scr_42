...
typedef void (*QState)(MEMMODEL struct QFsmTag *me);
...
* to QFsm_dispatch().
*/
void QFsm_init(MEMMODEL QFsm *me);
...
*/
void QFsm_dispatch(MEMMODEL QFsm *me) Q_REENTRANT;
...
typedef QState (*QHsmState)(MEMMODEL struct QHsmTag *me);
...
* to QHsm_dispatch().
*/
void QHsm_init(MEMMODEL QHsm *me);
...
*/
void QHsm_dispatch(MEMMODEL QHsm *me) Q_REENTRANT;
...
*/
QSTATE QHsm_top(MEMMODEL QHsm *me) Q_REENTRANT;
...
* \include qfn_arm.c
*/
void QActive_arm(MEMMODEL QActive *me, QTimeEvtCtr tout) Q_REENTRANT;

/** \brief Disarm a time event.
*
* The time event \a me gets disarmed and can be reused.
*/
void QActive_disarm(MEMMODEL QActive *me) Q_REENTRANT;
