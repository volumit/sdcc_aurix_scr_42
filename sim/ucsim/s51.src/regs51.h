...
#define B     0xda   /* SCR B register (secondary accumulator) */
#define SP	0xd4 /* SCR Stack Pointer */
#define DPL	0xd5 /* SCR Data Pointer Low byte */
#define DPH	0xd6 /* SCR Data Pointer High byte */
#define IE      0xd8 /* Interrupt Enable */
#define P2      0xde /* is used as page for xram */
...
//#define P2      0xa0 /* is used as page for xram */
