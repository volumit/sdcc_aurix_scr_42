...
newiTempOperand (sym_link * type, char throwType)
{
  ...
  //fprintf(stderr,"newiTempOperand\n");
  return op;
}
...
operandFromSymbol (symbol *sym, bool convert_sym_to_ptr)
{
  ...
  /* create :-                     */
  /*    itemp = &[_symbol]         */
  //fprintf(stderr,"operandFromSymbol implicit %d\n",sym->implicit);
  ...
  if (IS_ARRAY (sym->type))
    {
//      fprintf(stderr,"IS_ARRAY (sym->type)\n");
      IC_RESULT (ic) = geniCodeArray2Ptr (IC_RESULT (ic));
    }
  else
    {
//      fprintf(stderr,"IC_RESULT (ic)->isaddr\n");
...
//  if (p_type==SFRPOINTER) fprintf(stderr,"SFRPOINTER \n");
//  if (p_type==POINTER) fprintf(stderr,"POINTER \n");
//  if (p_type==IPOINTER) fprintf(stderr,"IPOINTER \n");
//}
  //fprintf(stderr,"operandFromSymbol End\n");
  ADDTOCHAIN (ic);
...
{
  operand *op;
  //fprintf(stderr,"operandFromValue \n");
