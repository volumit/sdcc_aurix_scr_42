...
static const ASM_MAPPING _gas_mapping[] = {
  ...
  {"one", "#0x01"},
  {"area", ".section %s ;area"},
  {"areacode", ".section %s ;areacode"},
  {"areadata", ".section %s ;areadata"},
  /*{"areahome", ".section %s ;areahome"},
  {"areacode", ".section %s,\"ax\" ;areacode"},
  {"areadata", ".section %s,\"w\" ;areadata"},
  {"areahome", ".section %s,\"ax\" ;areahome"},*/
  {"ascii", ".ascii\t\"%s\""},
  {"ds", ".ds.b\t%d"},
  {"db", ".byte"},
  {"dbs", ".byte\t%s"},
  ...
  {"immedword", "#0x%04X"},
  {"immedbyte", "#0x%02X"},
  {"immedwordnohash", "0x%04X"},
  {"immedbytenohash", "0x%02X"},
  {"hashedstr", "#%s"},
  {"lsbimmeds", "#<%s"},
  {"msbimmeds", "#>%s"},
  {"module", ".file\t\"%s.c\""},
