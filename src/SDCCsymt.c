      ...
      if (IS_DECL (src))
        {
          ...
          if (IS_PTR (src) && (IS_GENPTR (dest) || (((DCL_TYPE (src) == POINTER) || (DCL_TYPE (src) == SFRPOINTER)) && (DCL_TYPE (dest) == IPOINTER))))
            {
