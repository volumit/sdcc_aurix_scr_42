...
reg_info regs8051[] = {
  ...
  {REG_BIT, B0_IDX, REG_BIT, "bits_0", "bits_0", "bits", 0, 1},
  {REG_BIT, B1_IDX, REG_BIT, "bits_1", "bits_1", "bits", 1, 1},
  {REG_BIT, B2_IDX, REG_BIT, "bits_2", "bits_2", "bits", 2, 1},
  {REG_BIT, B3_IDX, REG_BIT, "bits_3", "bits_3", "bits", 3, 1},
  {REG_BIT, B4_IDX, REG_BIT, "bits_4", "bits_4", "bits", 4, 1},
  {REG_BIT, B5_IDX, REG_BIT, "bits_5", "bits_5", "bits", 5, 1},
  {REG_BIT, B6_IDX, REG_BIT, "bits_6", "bits_6", "bits", 6, 1},
  {REG_BIT, B7_IDX, REG_BIT, "bits_7", "bits_7", "bits", 7, 1},
...
/*  {REG_CND, CND_IDX, REG_CND, "C", "not_psw", "0xd0", 0, 1},
  ...
  {REG_CND, CND_IDX, REG_CND, "C", "not_psw", "CCCxxx", 0, 1},
  {0, DPL_IDX, 0, "dpl", "dpl", "dplxxx", 0, 0},
  {0, DPH_IDX, 0, "dph", "dph", "dphxxx", 0, 0},
  {0, B_IDX, 0, "b", "b", "bbbxxx", 0, 0},
  {0, A_IDX, 0, "a", "acc", "aaaxxx", 0, 0},
};
